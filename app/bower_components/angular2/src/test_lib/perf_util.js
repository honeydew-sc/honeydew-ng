System.register(["./e2e_util", "benchpress/benchpress"], function($__export) {
  "use strict";
  var bind,
      Options;
  ...
  $__export("runClickBenchmark", runClickBenchmark);
  $__export("runBenchmark", runBenchmark);
  return {
    setters: [function($__m) {
      $__export("verifyNoBrowserErrors", $__m.verifyNoBrowserErrors);
    }, function($__m) {
      bind = $__m.bind;
      Options = $__m.Options;
    }],
